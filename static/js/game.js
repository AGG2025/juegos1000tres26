    ...
    draw() {
        if(this.deadTimer > 0) {
            ...
            if (Math.floor(Date.now() / 150) % 2 === 0) {
                drawSprite(SPRITE_ALiEN_EXP, this.x, this.y, COLOR_PLAYER); // using alien exp for player death roughly
            }
        } else {
...
// Load sprites using a fake 'SPRITE_ALIEN_EXP' check to prevent drawing bugs
const SPRITE_ALiEN_EXP = [
    "0000001000000",
    "0000011100000",
    "0000011100000",
